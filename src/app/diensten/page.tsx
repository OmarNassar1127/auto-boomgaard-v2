...
const services = [
  ...
  },
  {
    id: 'leasen',
    title: 'Leasen',
    description: 'Bij Van Bruggen Automotive maken we het leasen van uw droomauto eenvoudig en zorgeloos. Samen met onze leasepartners bieden wij flexibele oplossingen voor zowel zakelijk als privélease. Rijd uw droomauto zonder zorgen met de leasemogelijkheden van Van Bruggen Automotive. Ontdek de vrijheid en luxe van leasen op maat!',
