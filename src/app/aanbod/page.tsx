        ...
        <div className="container-custom">
          ...
          <div className="mb-8 flex flex-wrap gap-4 text-sm">
            <div className="bg-white shadow-sm p-3 w-full max-w-xs">
              <label htmlFor="brand" className="block text-dark-dark/70 mb-1">Merk</label>
              <select
                id="brand"
            ...
            <div className="bg-white shadow-sm p-3 w-full max-w-xs">
              <label htmlFor="model" className="block text-dark-dark/70 mb-1">Model</label>
              <select
                id="model"
                className="w-full p-2 border border-gray-300 rounded"
              >
            ...
            <div className="bg-white shadow-sm p-3 w-full max-w-xs">
              <label htmlFor="priceRange" className="block text-dark-dark/70 mb-1">Prijs</label>
              <select
                id="priceRange"
                className="w-full p-2 border border-gray-300 rounded"
              >
                <option value="">Alle prijzen</option>
                <option value="0-30000">Tot €30.000</option>
