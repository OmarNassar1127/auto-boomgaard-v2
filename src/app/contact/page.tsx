        ...
        <div className="container-custom">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="bg-light p-8 rounded-lg shadow-md">
              <h2 className="text-2xl font-semibold text-dark-dark mb-6">Stuur ons een bericht</h2>

              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    <label htmlFor="name" className="block text-dark-dark/70 mb-1">Naam*</label>
                    <input
                      type="text"
                      id="name"
                      name="name"
                  ...
                  <div>
                    <label htmlFor="email" className="block text-dark-dark/70 mb-1">E-mail*</label>
                    <input
                      type="email"
                      id="email"
                      name="email"
                ...
                <div>
                  <label htmlFor="phone" className="block text-dark-dark/70 mb-1">Telefoon</label>
                  <input
                    type="tel"
                    id="phone"
                    name="phone"
                ...
                <div>
                  <label htmlFor="subject" className="block text-dark-dark/70 mb-1">Onderwerp*</label>
                  <select
                    id="subject"
                    name="subject"
                    required
                ...
                <div>
                  <label htmlFor="message" className="block text-dark-dark/70 mb-1">Bericht*</label>
                  <textarea
                    id="message"
                    name="message"
                    required
            ...
            <div className="space-y-8">
              <div>
                <h2 className="text-2xl font-semibold text-dark-dark mb-6">Contactgegevens</h2>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-dark-dark/80">
                        <Link href="tel:+31619201375" className="hover:text-gold transition-standard">
                          +31 6 19 20 13 75
                        </Link>
                      </p>
                    </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-dark-dark/80">
                        <Link href="mailto:info@vanbruggenautomotive.nl" className="hover:text-gold transition-standard">
              ...
              <div>
                <h2 className="text-2xl font-semibold text-dark-dark mb-6">Openingstijden</h2>
              ...
              <div>
                <h2 className="text-2xl font-semibold text-dark-dark mb-6">Locatie</h2>
