...
const JobListing = ({ title, location, type, description, jobId }: JobListingProps) => (
  <div className="bg-white p-6 rounded-lg shadow-md">
    <h3 className="text-xl font-semibold text-dark-dark mb-2">{title}</h3>
    <div className="flex flex-wrap gap-4 mb-4">
      <span className="bg-light text-dark-dark/70 px-3 py-1 rounded-full text-sm">{location}</span>
      <span className="bg-light text-dark-dark/70 px-3 py-1 rounded-full text-sm">{type}</span>
    </div>
    <p className="text-dark-dark/80 mb-6">{description}</p>
    <Button asChild className="bg-gold hover:bg-gold-dark text-white">
      <Link href={`/contact?vacancy=${jobId}`}>
        Solliciteer nu
      </Link>
    </Button>
  </div>
...
export default function VacaturesPage() {
  ...
  return (
    <div>
      <PageHero
        title="Vacatures"
        subtitle="Kom werken bij Van Bruggen Automotive"
        ...
        <div className="container-custom">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-dark-dark/80 mb-8">
              Zie je geen vacature die bij jou past, maar wil je toch graag bij ons komen werken?
              Stuur ons dan een open sollicitatie! We zijn altijd op zoek naar getalenteerde en
              gemotiveerde mensen die ons team kunnen versterken.
            </p>

            <Button asChild className="bg-gold hover:bg-gold-dark text-white">
              <Link href="/contact?vacancy=open">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="space-y-6 text-dark-dark/80">
                <p>
                  Bij Van Bruggen Automotive bieden we je een dynamische werkomgeving met ruimte voor
                  persoonlijke groei en ontwikkeling. We zijn een hecht team van autoenthousiasten die
                  samen werken aan het leveren van de beste service aan onze klanten.
                </p>
            ...
            <div className="bg-white p-8 rounded-lg shadow-md">
              <h3 className="text-xl font-semibold text-dark-dark mb-4">Sollicitatieprocedure</h3>

              <ol className="space-y-4 list-decimal pl-5 text-dark-dark/80">
                <li>
                  <strong>Sollicitatie indienen</strong><br />
                  Stuur ons je CV en motivatiebrief via het contactformulier.
                </li>
                <li>
                  <strong>Eerste selectie</strong><br />
                  We beoordelen je sollicitatie en nemen contact met je op als we je willen uitnodigen voor een gesprek.
                </li>
                <li>
                  <strong>Persoonlijk gesprek</strong><br />
                  Een gesprek met de directie waarin we je beter leren kennen en je meer vertellen over het bedrijf en de functie.
                </li>
                <li>
                  <strong>Eventueel tweede gesprek</strong><br />
                  Afhankelijk van de functie kan een tweede gesprek of meeloopdag volgen.
                </li>
                <li>
                  <strong>Arbeidsvoorwaardengesprek</strong><br />
                  Als we besluiten je een aanbod te doen, bespreken we de arbeidsvoorwaarden.
                </li>
                <li>
                  <strong>Indiensttreding</strong><br />
